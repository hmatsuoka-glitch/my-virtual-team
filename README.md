...
## 👥 チーム編成（<!-- AGENTS_COUNT -->56<!-- AGENTS_COUNT_END -->人）
...
| 14-経理財務部 | finance（経理・財務マネージャー） |
| 15-人事部 | hr（人事マネージャー） |
| 16-業務自動化部 | bo（業務自動化スペシャリスト） / owl（受注ワークフロー設計者） |
| 17-横断チーム | dat（横断データアナリスト） / kpi（横断KPIダッシュボードマネージャー） / pm（横断プロジェクトマネージャー） / qa（横断QAレビュアー） |
