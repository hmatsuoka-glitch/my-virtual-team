...
### 1. Modern Sales Stack (Salesforce + HubSpot + Gong)
- **導入内容**: CRM=Salesforce、MA=HubSpot、コール分析=Gong、電子契約=DocuSign の統合スタック。
- **導入基準**: 全営業活動で標準採用。
- **期待効果KPI**: 営業生産性 3倍／成約率 40%向上
- **連携先**: marketing、ryota、finance

### 2. Account-Based Marketing (ABM)
- **導入内容**: 大企業ターゲットに対して、CRM連動のパーソナライズ施策を展開。Terminus / 6sense活用。
- **導入基準**: 大企業ターゲット案件で必須。
- **期待効果KPI**: 大企業成約率 3倍／平均単価 5倍
- **連携先**: marketing、pr、ryota

### 3. Sales Enablement Content Library
- **導入内容**: 提案資料・事例集・ROIカリキュレーター・技術解説をライブラリ化し、営業が5分以内で必要資料を発見可能に。
- **導入基準**: 全営業活動で必須。
- **期待効果KPI**: 提案準備時間 8時間→1時間／成約率 40%向上
- **連携先**: yuto、rin、marketing

### 4. MEDDPICC Qualification Framework
- **導入内容**: Metrics/Economic Buyer/Decision Criteria/Decision Process/Paper Process/Identify Pain/Champion/Competition の8項目で商談を機械評価。
- **導入基準**: 全新規商談で必須。
- **期待効果KPI**: 見込み違い商談 60%削減／成約率 3倍
- **連携先**: haruto、ryota

### 5. Value Selling Framework
- **導入内容**: 機能売りから価値売りへ転換。「投資対効果ROI×導入前後Beforeアフター×リスク回避」の3軸提案標準化。
- **導入基準**: 全提案で必須採用。
- **期待効果KPI**: 平均単価 40%向上／値引き要求 60%削減
- **連携先**: ryota、marketing、haruto

### 6. Sales Cycle Acceleration
- **導入内容**: 商談ステージ別のPlaybook（ヒアリング→提案→クロージング→受注）を標準化。ボトルネック自動検知。
- **導入基準**: 全商談で必須運用。
- **期待効果KPI**: 商談期間 40%短縮／成約率 30%向上
- **連携先**: ryota、akari

### 7. Referral & Partnership Program
- **導入内容**: 既存クライアント紹介 / パートナー協業 / アライアンス営業 の3ルートを制度化。
- **導入基準**: 全既存クライアントで必須運用。
- **期待効果KPI**: 紹介経由売上 30%以上／新規獲得コスト 60%削減
- **連携先**: ryota、marketing、pr

### 8. Competitor Battle Card
- **導入内容**: 主要競合5社のBattle Card（強み/弱み/価格/導入事例/勝ちパターン）を整備し、商談で即活用。
- **導入基準**: 全新規商談で必須参照。
- **期待効果KPI**: 競合案件勝率 40%→65%／差別化提案率 100%
- **連携先**: rui、marketing、pr

### 9. Sales Analytics & Pipeline Management
- **導入内容**: パイプライン加重予測（ステージ×確度）で月次売上予測。異常検知アラート。
- **導入基準**: 全営業活動で必須。
- **期待効果KPI**: 売上予測精度 ±10%以内／異常検知遅延 24時間→即時
- **連携先**: finance、haruto、kpi

### 10. Objection Handling Master
- **導入内容**: 「価格が高い」「今は必要ない」「決裁権がない」「競合と比較したい」等の20頻出反論への対応スクリプト完備。
- **導入基準**: 全営業で必須トレーニング。
- **期待効果KPI**: クロージング率 40%向上／商談離脱 60%削減
- **連携先**: ryota、rei
