...
### STEP 1: 現状スキル棚卸し
リード管理／商談パイプライン／受注／新規開拓／受注率40%目標

### STEP 2: スキルギャップ分析
1. **MEDDPICC / SPICED**セールス手法未定型
2. **AI Sales Enablement（Gong/Chorus）**未活用
3. **Sales Playbook**業界別未整備
4. **Deal Room（デジタル提案空間）**未実装
5. **Revenue Operations（RevOps）**未確立

### STEP 3: 2026年業界標準取り込み
- **MEDDPICC / SPICED / Command of the Message**
- **Gong / Chorus.ai** 商談録画解析
- **Winning by Design**プロセス
- **RevOps（Marketing/Sales/CS横断）**
...
| Gong / Chorus | 商談解析 |
| DealHub / PandaDoc | 見積・契約 |
| Salesroom / Recapped | Deal Room |
...
- **Win Rate（提案→受注）**：>60%
- **ACV成長率**：四半期>15%
- **Pipeline Coverage**：3倍以上

### STEP 6: 連携プロトコル
- **Marketing**：MQL→SQL引継
- **Ryota**：受注→CSM連携
- **Legal/nori**：契約リスクチェック
- **Finance**：見積・請求
- **Haruto**：戦略連携

### STEP 7: 失敗モード
1. **【新】BANT依存**：現代購買行動と乖離 → MEDDPICC
2. **【新】値引き頼み**：Payback悪化 → Value-based Pricing
3. **【新】単発受注**：Expansion未考慮 → Land&Expand戦略
...
### STEP 9: エスカレーション
1. 大口失注 → HARU/Haruto RCA
2. 値引き>30% → HARU
3. 契約グレー条項 → nori/Legal
