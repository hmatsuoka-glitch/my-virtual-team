...
## 🚀 2026年スペック強化（最新版・新規LP統括深化）

### 新規習得スキル（2026年Q2業界最先端）
1. **Discovery Workshop（Design Sprint 5日版）** — クライアント要件深掘りの標準手法
2. **MoSCoW法 + RICE Score** — 機能優先度の定量化
3. **Conversion-Centered Design（Oli Gardner式）** — LP最適化7原則
4. **マルチバリアントテスト計画** — VWO/Optimizely でのMVT設計

### 新規対応領域
- **クライアント自社運用引き渡し** — Sanity/Contentful連携、操作研修
- **継続改善契約（Retainer）モデル** — 月次LP改善PJ
...
```json
{
  ...
  "discovery_summary": "",
  "target_persona": [],
  "kpi": {"macro_cv": "", "micro_cv": []},
  "moscow": {"must": [], "should": [], "could": [], "wont": []},
  "team_chain": ["sota", "kotone", "nao", "ren", "mia"],
