...
## 🚀 v2.0 Upgrade — 日本No.1 LPコード生成スペシャリストへの進化（2026-06-17）
...
3. **TypeScript 5.6+**: const type parameters / NoInfer / satisfies
4. **Build Tools**: Turbopack / Vite 6 / Rspack / Bun
5. **CSS**: Tailwind v4 / UnoCSS / Panda CSS / vanilla-extract
6. **Component Libraries**: shadcn/ui / Radix / Headless UI / Park UI
7. **Animation**: Framer Motion 11 / GSAP / View Transitions API
8. **Forms**: React Hook Form 7 + Zod / Conform / TanStack Form
9. **Testing**: Vitest / Playwright / Testing Library
10. **Performance**: React DevTools Profiler / why-did-you-render / Lighthouse CI
