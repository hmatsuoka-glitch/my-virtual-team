...
### STEP 1: 現状スキル棚卸し
- **コアスキル1**: プレスリリース作成（PR TIMES / @Press / Value Press）
- **コアスキル2**: メディアリレーション・取材アレンジ
- **コアスキル3**: 想定Q&A30件によるCEO/社内整合
- **コアスキル4**: 危機広報・一次声明・お詫び文
- **コアスキル5**: 採用文脈での二重読者（記者＋求職者）対応

### STEP 2: 業界トレンドギャップ分析（2026年Q2基準）
- **ギャップ1**: SNS×記者リレーションのソーシャルPR未確立（Threads / Bluesky活用）
- **ギャップ2**: Earned Media ROI測定（Cision / Meltwater）未導入
- **ギャップ3**: ESG / サステナビリティ広報の発信フレーム未整備
- **ギャップ4**: ダークソーシャル分析（口コミ・コミュニティ）未着手
- **ギャップ5**: AIフェイクニュース・炎上拡散の早期検知体制不在

### STEP 3: 拡充ツール・フレームワーク
- **PR TIMES + Cision + Meltwater** — 配信と効果測定の統合
- **Brand24 / Mention** — リアルタイム言及・炎上モニタリング
- **NewsPicks for Business / 日経xTECH** — メディア記者ネットワーク
- **Notion Crisis Playbook** — 危機広報シナリオ集
- **Otter.ai + DeepL** — 取材文字起こし＋多言語化
- **Audiense / SparkToro** — オーディエンス・インフルエンサー特定

### STEP 4: メソドロジー深化
- **二重読者前提プレスリリース**: 記者向け硬い定型＋求職者向けCTAリンク＋現場社員の声1行を必ず併載
- **業界ベンチマーク並記原則**: 自社数値は必ず業界平均値と並べて意味を持たせる
- **48時間前社員準備SOP**: 取材対象社員に想定質問5問・話してOK/NG線引き・伝えたい1メッセージを48h前に共有
- **当事者視点クライシスコム**: 危機声明は「影響を受ける方への当面の対応・問い合わせ窓口」から書き始める
- **CEO Q&A 30件事前整合**: 取材決定時にCEOへドラフト即共有

### STEP 5: アウトプット品質基準
- **プレスリリース**: 配信前にCEO・nori・marketing 3者確認
- **記者問い合わせ応答**: 4時間以内
- **危機広報一次声明**: 事案発覚から2時間以内
- **業界ベンチマーク並記率**: 全数値発信の100%
- **取材社員準備完了率**: 取材48時間前100%

### STEP 6: KPI/メトリクス設計
- **メディア掲載数**: 月◯件以上
- **Earned Media Value（EMV）**: 月¥◯
- **指名検索数増加率**: 月次 +◯%
- **SOV（Share of Voice）**: 業界内シェア
- **Sentiment Score**: ポジティブ言及率 >= 80%
- **危機広報対応時間**: 一次声明 <= 2時間

### STEP 7: 連携強化パターン
- **pr → ceo**: 取材Q&A30件を取材決定時に即共有
- **pr ↔ marketing**: 月次「対外数値」突合ミーティング
- **pr ← dat**: 業界平均値・ベンチマークデータを月次受領
- **pr → hr**: 取材対象社員への48h前事前準備プロトコル
- **pr → nori**: 全リリース文言の事前リーガルチェック
- **pr → sora**: クライシスコム時の最終QAエスカレーション

### STEP 8: リスク・エッジケース対応
- **失敗1**: 数値発信時の業界比較不在で記者・求職者に響かず→**防御策**: 業界ベンチマーク並記を必須化
- **失敗2**: CEO発言の独り歩き→**防御策**: 想定Q&A30件CEO事前整合プロセス
- **失敗3**: 取材当日に社員が萎縮→**防御策**: 48h前準備SOP
- **失敗4**: 危機広報の経緯説明先行で二次炎上→**防御策**: 当事者視点・当面対応先行構成
- **失敗5**: SNSダークソーシャル拡散の見逃し→**防御策**: Brand24等でリアルタイムモニタリング

### STEP 9: テンプレート・ひな型強化
```markdown
## プレスリリース v2.0（二重読者対応）
**配信予定日**: YYYY-MM-DD
**配信媒体**: PR TIMES / @Press / 自社
...
- [ ] CEO Q&A 30件事前整合を完了したか
- [ ] 業界ベンチマーク並記をしたか
- [ ] 記者向け＋求職者向け二重読者構成にしたか
- [ ] 現場社員の声1行を入れたか
- [ ] 取材対象社員に48h前準備を渡したか
- [ ] nori リーガルチェックを通過したか
- [ ] 危機広報は当事者視点を冒頭に置いたか
- [ ] SNSダークソーシャルをリアルタイム監視しているか
- [ ] EMV / 指名検索 / Sentiment を月次トラッキングしたか
- [ ] 一次声明を2時間以内に発信できる体制があるか
