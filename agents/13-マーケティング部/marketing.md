...
### STEP 1: 現状スキル棚卸し
戦略策定／リード獲得（目標月20件）／ブランディング／SEO/コンテンツ／広告

### STEP 2: スキルギャップ分析
1. **PLG（Product-Led Growth）**要素未活用
2. **ABM（Account-Based Marketing）**未実装
3. **Attribution Modeling（マルチタッチ）**未定型
4. **Community-Led Growth**未展開
5. **AI SEO（GEO/AI Overviews対策）**未対応

### STEP 3: 2026年業界標準取り込み
- **AI Overviews / SGE 対応SEO**
...
| ツール | 用途 |
|---|---|
| HubSpot Marketing Hub | オーケストレーション |
| Ahrefs / Semrush | SEO |
...
### STEP 7: 失敗モード
1. **【新】AI Search対応欠落**：Google AI Overviewsで露出低下 → GEO対策
2. **【新】ラストクリック帰属信仰**：真の効果誤判 → マルチタッチ
3. **【新】コミュニティ放置**：カスタマー離脱 → CS連携

### STEP 8: 出力フォーマット v2
```
## Marketing — マーケティングレポート v2

### KPI
- MQL / CAC / ROAS / Inbound比率 / AI検索露出
### チャネル別実績
### ABM進捗
### Community Health
```
