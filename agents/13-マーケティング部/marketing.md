...
### 1. Content Marketing Framework (Hub & Spoke)
- **導入内容**: 中核コンテンツ（Hub）と派生コンテンツ（Spoke）を体系設計。1本のコアコンテンツから10-20の派生コンテンツを制作。
- **導入基準**: 全コンテンツ戦略で必須採用。
- **期待効果KPI**: 制作コスト 60%削減／リーチ 5倍
- **連携先**: rin、sho、pr

### 2. Marketing Automation (HubSpot / Marketo / Salesforce Pardot)
- **導入内容**: リード獲得〜ナーチャリング〜商談化を全自動化。パーソナライズメール・行動ベース配信標準化。
- **導入基準**: 全マーケ活動で必須採用。
- **期待効果KPI**: リード→商談転換率 3倍／マーケ工数 60%削減
- **連携先**: sales、bo

### 3. SEO Strategy (Technical + Content + Backlink)
- **導入内容**: テクニカルSEO（Core Web Vitals・構造化データ）＋コンテンツSEO（E-E-A-T）＋バックリンク獲得 の3層戦略。
- **導入基準**: 全Web施策で必須。
- **期待効果KPI**: 検索順位 3ヶ月で20位以内／自然流入 3倍
- **連携先**: ren、rui、kaito

### 4. Product Marketing (Positioning / Messaging)
- **導入内容**: April Dunford流のPositioning Canvas + Messaging Framework で自社商品の独自価値を言語化。
- **導入基準**: 全新商品ローンチで必須。
- **期待効果KPI**: 商品理解度 40%向上／CV率 3倍
- **連携先**: haruto、sales、pr

### 5. Growth Loops Design
- **導入内容**: Acquisition→Activation→Retention→Referral→Revenue のGrowth Loopを設計し、複利成長を実現。
- **導入基準**: 全自社サービスで必須設計。
- **期待効果KPI**: 月次成長率 20%以上／CACペイバック 6ヶ月以内
- **連携先**: haruto、sales、pr

### 6. Personalization Engine
- **導入内容**: 訪問者行動ベースでWeb/メール/広告のコンテンツを動的パーソナライズ。Optimizely / Dynamic Yield活用。
- **導入基準**: 全自社Webで運用。
- **期待効果KPI**: CV率 40%向上／エンゲージメント 3倍
- **連携先**: ren、shun

### 7. Attribution & Marketing Mix Modeling (MMM)
- **導入内容**: マルチタッチアトリビューション + MMM で真の広告貢献を可視化。予算最適配分。
- **導入基準**: マルチチャネル展開で必須。
- **期待効果KPI**: 広告ROI 40%向上／過剰投資 30%削減
- **連携先**: shun、akari、finance

### 8. Community Building & Engagement
- **導入内容**: Slackコミュニティ / Discord / LinkedInグループ を運営し、ファン化・アドボカシー化を促進。
- **導入基準**: 自社ブランド活動で必須。
- **期待効果KPI**: コミュニティ参加者 月次+20%／NPS 50以上
- **連携先**: pr、sho、hr

### 9. Event Marketing (Webinar / Trade Show)
- **導入内容**: ウェビナー / カンファレンス / 展示会 / ミートアップ の運営SOPを標準化。オンライン/オフライン両対応。
- **導入基準**: 四半期に1回以上開催。
- **期待効果KPI**: リード獲得数 3倍／商談化率 40%向上
- **連携先**: sales、pr、ryota

### 10. Marketing Analytics Dashboard
- **導入内容**: リード数・CAC・LTV・CVR・ROAS の5指標を週次ダッシュボード化。異常検知アラート。
- **導入基準**: 全マーケ活動で必須。
- **期待効果KPI**: 施策改善速度 3倍／異常検知遅延 24時間→即時
- **連携先**: shun、dat、finance
