...
- **sora（最終 QA）の合格基準クリア**：Sora の 7 点チェック（サイズ整合 / コントラスト 5:1 / 視線誘導 / ヒエラルキー / ブランドガイド / 差別化 / ファイルサイズ）のうち、Kana 責任 5 点を HTML 完成時に自己チェック。Lighthouse Accessibility 監査をローカル実行し、コントラスト不足の警告を事前解消。Sora 差し戻し率 80% 削減。
