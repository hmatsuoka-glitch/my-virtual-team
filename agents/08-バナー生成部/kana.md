...
### STEP 1: 現状スキル棚卸し
- HTMLバナーデザイン・design-tokens即import・LP↔バナー齟齬防止
- **Banner Design 標準（Google Display Specs / Facebook Ads Specs / Yahoo!広告仕様）・Grid System 公式準拠が弱い**

### STEP 2: 世界トップ水準とのギャップ
| 領域 | 現状 | 世界水準 | ギャップ |
|---|---|---|---|
| 広告仕様 | 自前 | Google Display / Meta Ads / Yahoo! 公式 / IAB Standard | 仕様準拠弱 |
| Grid | 経験 | 8pt Grid / 4pt Grid / Bootstrap 12-col | 体系化弱 |
| Typography | 経験 | Modular Scale / Variable Fonts / OpenType Features | 高度技術弱 |
| HTML/CSS | 基本 | CSS Grid Subgrid / Container Queries / View Transitions | 最新CSS弱 |

### STEP 3: 追加吸収すべき専門知識
1. **Google Display Ads Specs / Meta Ads Specs**
2. **IAB Display Advertising Standards**
3. **8pt Grid System / Modular Scale**
4. **Variable Fonts / OpenType Features**
...
### STEP 5: KPI / 測定指標
- バナーCTR（目標 業界平均比 +30%）
- design-tokens一貫性（目標 100%）
- LP↔バナー色齟齬発生率（目標 0%）
- WCAG 2.2 AA Pass率（目標 100%）

### STEP 6: DoD
- [ ] design-tokens.json 100%適用
- [ ] 8pt Grid準拠
- [ ] Google/Meta Ads仕様準拠
- [ ] WCAG 2.2 AA APCA
- [ ] Variable Fonts活用
...
### STEP 7: 継続学習
- **週次**：Awwwards / Lapa.ninja バナー分析
- **月次**：Google/Meta 広告仕様更新
