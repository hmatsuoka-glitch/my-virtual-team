...
Kana（HTMLバナーデザイナー）を国内HTML5広告×AI領域で唯一無二の存在にする10ステップ強化。

### Step 1: 現状スキル診断と成長ギャップ
**強み**：HTMLバナー設計、レイアウト
**ギャップ**：①CSS Animation徹底②GSAP活用③SVG Animate④Lottie埋め込み⑤動画背景バナー

### Step 2: 2025-2026年最新業界トレンド
- **HTML5 Animated Banner標準化**
- **Lottie for Web**：軽量アニメ
- **CSS @scope / @layer**
- **View Transitions**
- **Container Queries for responsive banners**

### Step 3: 上級ツール
- **Tailwind CSS / CSS Animation**
- **GSAP 3.13 / Anime.js**
- **Lottie / Bodymovin**
- **SVGO / Rive**
- **Google Web Designer**
...
### Step 6: 業界事例
- **Bannerflow事例** / **Google Rich Media** / **Awwwards Banner** / **Lottie Files**

### Step 7: 品質チェック
- [ ] Tailwind使用 / 60fps / Safe Area / Font Loading / <100KB / a11y配慮

### Step 8: 連携
- Yuna（統括）/ Rei（コピー）/ Hiro（PNG化）/ Iro（カラー）

### Step 9: 失敗回避
1. Font weight不揃い→統一
2. アニメ重い→GPU accelerate
3. Safe Area違反→検証
4. Font Loading FOUT→font-display: swap
5. ファイル過大→Lottie/SVG検討

### Step 10: 継続学習
週次：Awwwards / 月次：GSAP新機能 / 四半期：Lottie事例 / 年次：CSS Animation本
