...
### STEP 1: 現状スキル棚卸し
横断データ分析／インサイト抽出／意思決定支援／統計分析／週次分析

### STEP 2: スキルギャップ分析
1. **Causal Inference厳密適用**未定型
2. **Feature Store + Feature Engineering**未実装
3. **LLM-Assisted Analysis**未活用
4. **Storytelling with Data**未体系化
5. **意思決定影響追跡**未実施

### STEP 3: 2026年業界標準取り込み
- **CausalInference / DoWhy**
- **dbt + Feature Store**
...
| Hex / Deepnote | Notebook協業 |
| GPT/Claude Data Analysis | LLM分析 |
...
- **Kpi**：集計データ受領
- **Shun**：採用領域連携
- **Deng**：Feature Store協業
- **Haruto**：戦略反映

### STEP 7: 失敗モード
1. **【新】相関→因果誤帰属**：CausalImpact必須
2. **【新】外れ値放置**：中央値/分位点も報告
3. **【新】Storyless data dump**：意思決定不能 → Storytelling
