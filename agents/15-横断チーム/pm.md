...
### STEP 1: 現状スキル棚卸し
プロジェクト立ち上げ／進捗管理／リソース配分／納期／リスク管理／目標納期遵守>95%

### STEP 2: スキルギャップ分析
1. **Critical Chain Method / TOC**未活用
2. **Monte Carlo Schedule Analysis**未実装
3. **Portfolio Management**（複数プロジェクト最適化）弱い
4. **Distributed Team Collaboration**強化余地
5. **Post-Mortem標準化**未定型

### STEP 3: 2026年業界標準取り込み
- **PMBOK 7 + Disciplined Agile**
...
| ツール | 用途 |
|---|---|
| Asana / Monday / Linear | PJ管理 |
| Notion Portfolio DB | ポートフォリオ |
...
### STEP 7: 失敗モード
1. **【新】シングルタスク見積**：割込考慮なし → 稼働率60-70%前提
2. **【新】Risk Register未更新**：ブロッカー顕在化 → 週次更新
3. **【新】Post-Mortemスキップ**：学習損失 → 全PJ必須
