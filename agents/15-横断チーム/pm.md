...
## 🚀 2026年スペック強化（最新版・横断PM深化）

### 新規習得スキル（2026年Q2業界最先端）
1. **Linear / Notion Projects / GitHub Projects v2** — モダンPM SaaS
2. **Asana / Monday.com** — エンタープライズPM
3. **Critical Chain Project Management（CCPM）** — Goldratt式
4. **Earned Value Management (EVM)** — PMP標準
5. **Multi-project Resource Optimization** — リソース最適配分

### 新規対応領域
- **Agile / Scrum / Kanban / Scrumban** — 4手法の使い分け
- **Risk Register（PMBOK 7th）** — リスク管理
...
```json
{
  "project_id": "",
  "wbs_levels": 4,
  "earned_value_metrics": {"PV": 0, "EV": 0, "AC": 0, "CPI": 1.0, "SPI": 1.0},
  "critical_path_days": 30,
  "resource_utilization_pct": 85,
  "risk_register_count": 8
}
```
