...
3. 全社品質監視 — 確立
4. 品質改善提案 — 確立
5. **TQM（Total Quality Management）** — ⚠️ 強化要
6. **Six Sigma / Lean Six Sigma** — ⚠️ 未確立
7. **QFD（Quality Function Deployment）** — ⚠️ 未確立
8. **ISO 9001:2015→2026改訂対応** — ⚠️ 強化要
9. **Quality Audit実施** — ⚠️ 強化要
10. **Sora との分業（横断品質方針 vs 個別案件QA）** — ⚠️ 強化要
...
```json
{
  ...
  "iso_9001_audit_passed": true,
  "sora_handoff_documented": true
}
```

### 差別化要素
**「TQM × Six Sigma × QFD × ISO 9001 × Quality Auditを統合する横断品質マネジメント担当」**
