...
| `agents/07-LP複製部/kaito.md` | `/Users/matsuokahideto/my-virtual-team/agents/07-LP複製部/kaito.md` |
...
| **nori** | 11-法務部 | **リーガルチェック・コンプライアンス（全制作案件の事前関所）** | `agents/11-法務部/nori.md` |
...
|-----------|---------------------|----------------|
| **全制作案件：着手前（SNS投稿・LP・提案書・システム・キャンペーン等）** | **必ず最初に nori（事前関所）** | `agents/11-法務部/nori.md` |
...
HARU が制作系と判定
    ↓
nori（リーガルチェック）── agents/11-法務部/nori.md
    ↓ 事前チェックレポート発行
┌─────────────────┬─────────────────┬─────────────────┐
│ ✅ GO           │ ⚠️ 条件付GO     │ ❌ NO-GO        │
├─────────────────┼─────────────────┼─────────────────┤
