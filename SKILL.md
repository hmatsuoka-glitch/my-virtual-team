...
| **gen** | 16-建設業DXシステム部 | **どっと原価・建設業DX資料ナレッジ（Q&A・提案支援）** | `agents/16-建設業DXシステム部/gen.md` |
...
| **どっと原価・原価管理・インボイス・2024年問題・建設業法等の質問/資料参照** | **gen**（Q&Aはnori関所不要） | `agents/16-建設業DXシステム部/gen.md` |
